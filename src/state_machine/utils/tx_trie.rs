...
use crate::core::traits::TransactionTrait;
...
pub fn build_tx_trie<T: TransactionTrait>(txs: &Vec<T>) -> (RootHash, TreeUpdateBatch, MockTreeStore) {
...
pub fn get_tx_proof<T: TransactionTrait>(txs: &Vec<T>) -> SparseMerkleRangeProof {
