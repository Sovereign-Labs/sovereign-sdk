...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let rollup = new_rollup_with_celestia_da::<Risc0Vm>(&rollup_config_path, Some(host)).await?;
    ...
    //     if height != 57 {
    //         println!(
    //             "Starting block {}. Input state root {}",
    //             height, hex::encode(&prev_state_root)
    //         );
    ...
    //         info!("Finished processing block {}", height,);
    //         continue;
    //     }
