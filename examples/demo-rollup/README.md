...
```text
2025-10-27T09:43:16.340344Z  INFO sov_cli::workflows::node: Executing node workflow
2025-10-27T09:43:16.357840Z  INFO sov_cli::workflows::node: Submitting tx index=0 tx_hash=0x657c6227931207216005e446513d66d6cd4af163f250a570670b224f4f59de72
2025-10-27T09:43:16.357859Z  INFO sov_node_client: Calling `publish_batch` sequencer endpoint txs_included=1
2025-10-27T09:43:16.367589Z  INFO sov_node_client: Submitted tx hash="0x657c6227931207216005e446513d66d6cd4af163f250a570670b224f4f59de72"
2025-10-27T09:43:16.367612Z  INFO sov_node_client: Going to wait for batch to be processed max_waiting_time=300s
2025-10-27T09:43:18.458914Z  INFO sov_node_client: Rollup has processed the submitted batch!
```
...
$ sleep 5
$ curl -sS http://127.0.0.1:12346/ledger/txs/0x657c6227931207216005e446513d66d6cd4af163f250a570670b224f4f59de72/events | jq
[
  {
    "type": "event",
    "number": 0,
    ...
    "tx_hash": "0x657c6227931207216005e446513d66d6cd4af163f250a570670b224f4f59de72"
  }
]
```
...
Adding the following transaction to batch:
{
  ...
  "chain_hash": "0xc6e6b319930b8b8c0550f548c7a3454e15a2193ae5c309283fddb46c43eeabda",
  "details": {
