...
If you want to manually build the programs, you can do so within the `guest-mock` or `guest-aggregation-mock` directory by installing the SP1 `cargo prove` toolchain and then running:
