...
use sov_stf_runner::{ParallelProver, RollupConfig, RollupProverConfig};
...
impl RollupBlueprint for CelestiaDemoRollup {
    ...
    type ProverService = ParallelProver<
    ...
    async fn create_prover_service(
        ...
        ParallelProver::new(vm, zk_stf, da_verifier, prover_config, zk_storage)
    }
}
