...
use reqwest::Url;
use serde::Serialize;
use sov_demo_rollup::{mock_da_sp1_host_args, MockDemoRollup, MockRollupSpec};
...
async fn start_node(
    _rollup_prover_config: RollupProverConfig<SP1>,
...
pub async fn setup_test_rollup(
    ...
    let host_args = mock_da_sp1_host_args();
