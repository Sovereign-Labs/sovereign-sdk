...
pub const EXAMPLE_SEQUENCER_DA_ADDRESS: [u8; 32] = [1; 32];
pub const LOCKED_AMOUNT: u64 = 200;
pub const EXAMPLE_SEQ_PUB_KEY_STR: &str = "seq_pub_key";
pub const EXAMPLE_TOKEN_NAME: &str = "sov-test-token";
...
pub fn create_demo_config(
    ...
    create_demo_genesis_config::<DefaultContext>(
        ...
        generate_address::<DefaultContext>(EXAMPLE_SEQ_PUB_KEY_STR),
        EXAMPLE_SEQUENCER_DA_ADDRESS.to_vec(),
...
pub fn create_demo_genesis_config<C: Context>(
    ...
    let token_config: bank::TokenConfig<C> = bank::TokenConfig {
        token_name: EXAMPLE_TOKEN_NAME.to_owned(),
