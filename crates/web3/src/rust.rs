...
//! - Building pure Rust applications with access to compile-time generics
//! - You have the required generic type parameters (`Spec`, `ChainHash`, etc.)
//! - Performance is critical and you want zero-cost abstractions
//! - Working entirely within the Rust ecosystem
//! - You need compile-time type safety and validation
//!
//! ## Comparison with `schema` Module
//!
//! This crate provides two different approaches for transaction building and serialization:
//!
//! ### `rust` Module (Compile-time Generics) - This Module
...
//!
//! If you're working in pure Rust and have access to the necessary generic type
