...
The JS implementation lives here: https://github.com/Sovereign-Labs/sovereign-sdk/tree/dev/typescript/packages/serializers
...
```
SOV_UNIVERSAL_WALLET_FUZZ_JS_DIR="../../../typescript/packages/serializers" cargo fuzz run fuzz_js_impl --fuzz-dir . --features js-compat
```

Where `SOV_UNIVERSAL_WALLET_FUZZ_JS_DIR` is the path to the `serializers` package in the [typescript code](https://github.com/Sovereign-Labs/sovereign-sdk/tree/dev/typescript/packages/serializers).
