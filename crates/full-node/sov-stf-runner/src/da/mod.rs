...
//             get_new_head_height_if_roll_back(sync_state, requested_height); // returns sync_state.target_da_height if that is less than requested_height
...
//                 // No log;
//                 //  "DA head rolled back below requested height, retrying with new head," is present therefore, we fetched the block at requested_height
//                 tracing::warn!(
//                     requested_height,
