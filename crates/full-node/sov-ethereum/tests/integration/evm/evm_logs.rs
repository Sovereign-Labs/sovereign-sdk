...
use crate::common::{assert_invalid_params, rpc_call, setup_with_simple_storage, EVM_EXTENSION};
...
async fn setup_two_contracts() -> (
    TestRollup<crate::runtime::EvmBlueprint>,
    SimpleStorageClient,
    Address,
    Address,
) {
...
struct RollupAndClient {
    test_rollup: TestRollup<crate::runtime::EvmBlueprint>,
    client: SimpleStorageClient,
