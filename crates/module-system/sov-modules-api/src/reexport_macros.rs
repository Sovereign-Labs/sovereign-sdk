...
/// through the API.
///
/// Generated [`StateMap`](crate::containers::StateMap) endpoints use URL
...
pub mod macros {
    ...
    /// ## Chain metadata
    ///
    /// The per-network chain-identity constants — `CHAIN_ID`, `CHAIN_NAME`,
    ...
    /// separate file means editing chain identity only recompiles the crates
