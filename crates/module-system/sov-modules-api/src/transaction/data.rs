    ...
    pub fn gas_meter(
        ...
        match &self.0.gas_limit {
            Some(gas_limit) => {
                ...
                BasicGasMeter::new_with_funds_and_gas(self.0.max_fee, new_gas_limit, gas_price)
            }
            None => {
                BasicGasMeter::new_with_funds_and_gas(self.0.max_fee, *slot_gas_limit, gas_price)
            }
        }
    }
}
