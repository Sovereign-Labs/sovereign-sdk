...
pub enum GasMeteringError<GU: Gas> {
    ...
    #[error("The slot gas limit has been exhausted. Initial slot gas: {initial_slot_gas}, gas to charge {gas_to_charge}, remaining total slot gas {remaining_total_slot_gas}, remaining preferred slot gas {remaining_preferred_slot_gas}, is preferred {is_preferred}")]
    SlotOutOfGas {
        /// The initial slot gas limit.
        initial_slot_gas: GU,
        /// The amount of gas to charge.
        gas_to_charge: GU,
        /// The remaining preferred gas.
