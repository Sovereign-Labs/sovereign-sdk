...
export interface TupleType {
  /**
   * The name of the tuple struct (e.g. newtype) this type was derived from, if any.
   * `null` for plain anonymous tuples and for the virtual tuples representing enum
   * variant contents. Purely informational; absent in schemas generated by older SDKs.
   */
