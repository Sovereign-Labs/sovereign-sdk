...
-   Updated dependencies [8c28feb]
    ...
    -   @sovereign-sdk/serializers@0.2.0
...
-   fa0c0cc: Added support for encoding transactions as a solana offchain messages, for rollups that use the corresponding authenticator. Use the `SolanaSignableRollup` and select the desired encoding.
