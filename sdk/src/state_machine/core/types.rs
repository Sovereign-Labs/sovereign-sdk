...
// pub struct RollupHeader<DaLayer: DaVerifier, App: StateTransitionFunction> {
...
// impl<D: DaVerifier, A: StateTransitionFunction> Encode for RollupHeader<D, A> {
//     fn encode(&self, _target: &mut impl std::io::Write) {
//         todo!()
//     }
// }

// impl<D: DaVerifier, A: StateTransitionFunction> Decode for RollupHeader<D, A> {
//     type Error = ();
...
// impl<'de, D: DaVerifier, A: StateTransitionFunction> DecodeBorrowed<'de> for RollupHeader<D, A> {
//     type Error = ();
...
// impl<DaLayer: DaVerifier, App: StateTransitionFunction> RollupHeader<DaLayer, App> {
...
// pub struct RollupBlock<DaLayer: DaVerifier, App: StateTransitionFunction> {
...
// pub struct AugmentedRollupBlock<DaLayer: DaVerifier, App: StateTransitionFunction> {
