...
[Chainway](https://chainway.xyz/) team also maintains a Bitcoin DA adapter for their Sovereign Rollup on Bitcoin, which can be found [here](https://github.com/chainwayxyz/bitcoin-da).
