...
pub trait Runtime<C: Context, Da: DaSpec>:
    ...
    + ApplyBlobHooks<
        Da::BlobTransaction,
        Context = C,
        BlobResult = SequencerOutcome<<Da::BlobTransaction as BlobReaderTrait>::Address>,
...
impl<C, RT, Zk, DA> AppTemplate<C, DA, Zk, RT>
where
    C: Context,
    Zk: ZkVerifier,
    DA: DaSpec,
...
impl<C, RT, Zk, DA> StateTransitionFunction<Zk, DA> for AppTemplate<C, DA, Zk, RT>
where
    C: Context,
    DA: DaSpec,
    Zk: ZkVerifier,
