...
pub struct GasConfig<GasUnit> {
    pub matrix_mul_cost: GasUnit,
    pub expensive_check_loop_step_cost: GasUnit,
}
...
impl<C: sov_modules_api::Context> SomeModule<C> {
    pub(crate) fn some_complex_math_operation(
        ...
        working_set.charge_gas(&self.gas_config.matrix_mul_cost)?;
    ...
    pub(crate) fn some_expensive_check_in_loop(
        ...
        for i in 0..100 {
            working_set.charge_gas(&self.gas_config.expensive_check_loop_step_cost)?;
