...
use sov_modules_api::{BlobReaderTrait, CallResponse, Context, DaSpec, Error, ModuleInfo, Spec};
...
pub type DaAddressSpec<Da: DaSpec> = <<Da as DaSpec>::BlobTransaction as BlobReaderTrait>::Address;
        ...
        borsh::BorshSerialize + borsh::BorshDeserialize,
{
    ...
    pub seq_da_address: DaAddressSpec<Da>,
...
pub struct SequencerRegistry<C: Context, Da: DaSpec>
where
    <<Da as DaSpec>::BlobTransaction as BlobReaderTrait>::Address:
        borsh::BorshSerialize + borsh::BorshDeserialize,
{
    ...
    #[state]
    pub(crate) allowed_sequencers: StateMap<DaAddressSpec<Da>, C::Address>,
    ...
    #[state]
    pub(crate) preferred_sequencer: StateValue<DaAddressSpec<Da>>,
...
// TODO: Next step, add generic here
...
impl<C: Context, Da: DaSpec> sov_modules_api::Module for SequencerRegistry<C, Da>
where
    <<Da as DaSpec>::BlobTransaction as BlobReaderTrait>::Address:
        borsh::BorshSerialize + borsh::BorshDeserialize,
{
