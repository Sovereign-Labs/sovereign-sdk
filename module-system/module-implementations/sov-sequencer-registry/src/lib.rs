...
pub struct SequencerRegistry<C: sov_modules_api::Context, B: BlobReaderTrait>
where
    B::Address: borsh::BorshSerialize + borsh::BorshDeserialize,
{
    ...
    #[state]
    pub(crate) allowed_sequencers: StateMap<B::Address, C::Address>,
    ...
    #[state]
    pub(crate) preferred_sequencer: StateValue<B::Address>,
...
impl<C: sov_modules_api::Context, B: BlobReaderTrait> sov_modules_api::Module
    for SequencerRegistry<C, B>
where
    B::Address: borsh::BorshSerialize + borsh::BorshDeserialize,
{
    type Context = C;
    ...
    B::Address: borsh::BorshSerialize + borsh::BorshDeserialize,
{
    ...
    pub(crate) fn register_sequencer(
        ...
        if self.allowed_sequencers.get(&d, working_set).is_some() {
            anyhow::bail!(
                "sequencer {} is already registered on {}",
                d,
                rollup_address
            )
        }
        ...
        self.allowed_sequencers.set(&d, rollup_address, working_set);
