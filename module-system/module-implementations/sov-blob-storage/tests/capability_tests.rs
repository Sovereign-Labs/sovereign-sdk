...
fn priority_sequencer_flow() {
    ...
    let mut execute_in_slot_1 =
        <BlobStorage<DefaultContext> as BlobSelector<MockDaSpec>>::get_blobs_for_this_slot(
            &blob_storage,
            &mut slot_1,
            &mut working_set,
        )
