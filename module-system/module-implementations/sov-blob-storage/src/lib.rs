...
pub struct BlobStorage<C: sov_modules_api::Context, Da: sov_rollup_interface::da::DaSpec> {
...
impl<C: sov_modules_api::Context, Da: sov_rollup_interface::da::DaSpec> Module
    for BlobStorage<C, Da>
{
    type Context = C;
    type Config = ();
