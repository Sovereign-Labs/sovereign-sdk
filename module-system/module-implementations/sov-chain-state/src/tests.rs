...
use sov_rollup_interface::mocks::{MockBlockHeader, MockDaSpec, MockHash, MockValidityCond};
...
fn test_simple_chain_state() {
    ...
    chain_state.begin_slot_hook(&new_header, &new_validity_condition, &mut working_set);
